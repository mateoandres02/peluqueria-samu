...
const actionBtnWsp = (name, day, startTime, tel, $btnWsp) => {
  ...
  $btnWsp.addEventListener('click', async (e) => {
    ...
    const msg = `¡Hola ${name}! Espero que te encuentres muy bien. Solo quería recordarte que tenés un turno agendado para el día ${day} a las ${startTime} hs. ¡Te esperamos!. IMPORTANTE❗❗ Ahora cambiamos de ubicación y estamos en Nicolás Isasmendi 1995, en esquina con chachapoyas.`;
